...
function addCmdToTable(_cmd) {
  ...
  tr += '<input class="cmdAttr form-control input-sm" style="display:none;margin-top:3px" data-l1key="configuration" data-l2key="message" placeholder="{{Message}}" title="{{Message}}"/> '
  tr += '</td>'
  tr += '<td>'
